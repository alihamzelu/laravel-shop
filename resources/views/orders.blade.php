...
<head>
    ...
    <title>My Orders | Tech World</title>
    ...
    <main class="container mx-auto px-4 py-8">
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-3/4 space-y-6">
                ...
                <div>
                    <h1 class="text-2xl font-black text-white uppercase tracking-tight">Order History</h1>
                            ...
                            <tbody class="text-gray-300 divide-y divide-gray-800/50">
                                ...
                                <tr class="hover:bg-[#161922]/20 transition duration-150">
                                    ...
                                    <td class="py-4">
                                        ...
                                        <span class="bg-blue-500/10 text-blue-400 font-bold px-2 py-0.5 rounded border border-blue-500/20 uppercase tracking-wide text-[10px]">
                                            {{ $order->status }}
                                        </span>
